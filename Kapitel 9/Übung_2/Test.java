...
public class Test
{
    public static void main(String[] args)
    {
        ...
        Angestellter hans = new Angestellter("Hans Kirch", 123);
        Angestellter hanna = new Angestellter("Hanna Kirch", 123);  
        ...
        System.out.println("Angestellte untereinander: " + hans.equals(hanna));
        System.out.println("Professor + Angestellter: " + hans.equals(einProf));
    }   
}