...
{ 
    ...
    /**
     * Führt eine Aktion aus - eine Freiwillige zersägen - und informiert die Zuschauer
     */
    ...
    {      
        class Freiwillige
        {
            ...
            Freiwillige(String name)    
            {
                this.name = name;
                System.out.println("Ich bin Freiwillige bei der Veranstaltung " + MOTTO);
            }
            
            @Override
            public String toString()
            {
                return name + " (Instanz der Klasse " + getClass() + ")"; 
            }
        }
        
        Freiwillige freiwillige = new Freiwillige("Katrin");
        
        System.out.println("Ich zersäge jetzt " + freiwillige);        
        setChanged();
        notifyObservers(FeuerspuckerAction.getAction());        
    }
    ...
    /**
     * Führt eine Aktion aus - jonglieren - und informiert die Zuschauer
     */
